...
- 🎨 **Красиві сторінки** - Чисті сторінки 404 та індексу з 3 темами
...
| ![Логін світла](screenshots/login-light.png) | ![Логін темна](screenshots/login-dark.png) | ![Логін тепла](screenshots/login-warm.png) |
